	...
	public void getCode(final String phone) {
		...
		jmsTemplate.send(smsDestination, new MessageCreator() {
			...
			public Message createMessage(Session session) throws JMSException {
				...
				mapMessage.setString("jsonCode",jsonCode);
				return mapMessage;

//				map.get("phone"), map.get("signName"), map.get("templateCode"), map.get("jsonCode")
			}
		});
	...
	public boolean checkCode(String phone,String code) {
		...
		String redisCode = (String) redisTemplate.boundHashOps("checkCode").get(phone);
