				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom"><img jqimg="${imageList[0].url}" src="${imageList[0].url}" width="400px" height="700px"  /></span>
						</div>
						<!--下方的缩略图-->
							...
							<div class="items">
								<ul>
								    <#list imageList as image>
									    <li><img src="${image.url}" onmousemove="preview(this)" /></li>
									</#list>
						  ...
						  <#list specificationList as spec>
							<dl>
								...
								<#list spec.attributeValue as option>
								    <dd><a href="javascript:;" class="{{isSpecSelected('${spec.attributeName}','${option}')?'selected':''}}"  ng-click="selectSpec('${spec.attributeName}','${option}')">${option}<span title="点击取消选择" >&nbsp;</span></a></dd>
								</#list>
